## 1. Specification
- [ ] 1.1 Define Settings placement for global Studio Runner defaults and Runner workspace behavior without editable settings above Runner Log.
- [ ] 1.2 Define model/effort defaults, allowed values, and global runner scope.
- [ ] 1.3 Define dispatch-time application of explicit global Runner settings through optional execution metadata.
...
## 2. Implementation
- [ ] 2.1 Add global Runner settings state to the app model and persistence layer.
- [ ] 2.2 Remove/compact static overview cards above Runner Log without replacing them with editable Runner settings in the Runner workspace.
- [ ] 2.3 Add model and effort controls to Settings using existing settings/design-system patterns.
- [ ] 2.4 Serialize explicit non-default global Runner settings as optional execution metadata in Studio Runner dispatch events.
...
## 3. Verification
- [ ] 3.1 Add/update app-model and persistence tests for global Runner settings.
