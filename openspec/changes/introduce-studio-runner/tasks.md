...
- [x] 2.1 Add local Studio Runner settings UI/state on a first-class Runner workspace tab and context inspector.
- [x] 2.2 Add runner status detection and display in the Runner page inspector plus compact selected-change dispatch state.
